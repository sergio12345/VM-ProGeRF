...
public class progerfmain {
	...
	for( k=0; k < args.length ; k++ ){
        ...
        */
        ...
        for( t=fragmin ; t <= fragmax ; t++ ){
            ...
            if(modoDeExecucao == 0){
                ...
                myThreads[contThread] = new Thread(new wThread( entrada,  t,  rep,  gaps, saida, 4));
                myThreads[contThread].start();
            }else{
                // protein
                System.out.printf("Protein\n\n");
                myThreads[contThread] = new Thread(new wThread( entrada,  t,  rep,  gaps, saida, 20));
                myThreads[contThread].start();
            }
        ...
        */
        ...
        // OrdenaLista: pega o arraylist e o ordena de acordo com a posicao final
